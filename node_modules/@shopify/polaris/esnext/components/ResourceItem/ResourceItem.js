...
class BaseResourceItem extends React.Component {
    ...
    render() {
        const { children, url, media, shortcutActions, ariaControls, ariaExpanded, persistActions = false, polaris: { intl }, accessibilityLabel, name, context: { selectable, selectMode, loading }, } = this.props;
        ...
        if (selectable) {
            const checkboxAccessibilityLabel = name || accessibilityLabel || intl.translate('Polaris.Common.checkbox');
...
export default withAppProvider()(ResourceItem);
