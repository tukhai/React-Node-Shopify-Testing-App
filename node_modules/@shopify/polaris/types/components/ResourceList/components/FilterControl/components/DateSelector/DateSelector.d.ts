...
declare type CombinedProps = DateSelectorProps & WithAppProviderProps;
...
declare const _default: React.FunctionComponent<DateSelectorProps> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof DateSelector) | (React.FunctionComponent<CombinedProps> & typeof DateSelector), {}>;
