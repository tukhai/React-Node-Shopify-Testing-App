...
export declare type CombinedProps = SkeletonPageProps & DeprecatedProps;
export declare function SkeletonPage({ children, fullWidth, narrowWidth, singleColumn, primaryAction, secondaryActions, title, breadcrumbs, }: CombinedProps): JSX.Element;
export {};
