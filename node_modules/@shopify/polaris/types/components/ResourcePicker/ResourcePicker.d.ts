...
declare const _default: React.FunctionComponent<ResourcePickerProps> & import("hoist-non-react-statics").NonReactStatics<(React.ComponentClass<CombinedProps, any> & typeof ResourcePicker) | (React.FunctionComponent<CombinedProps> & typeof ResourcePicker), {}>;
